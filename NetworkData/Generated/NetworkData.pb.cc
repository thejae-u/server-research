...
template <typename>
PROTOBUF_CONSTEXPR AtkData::AtkData(::_pbi::ConstantInitialized)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(_class_data_.base()),
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(),
...
struct AtkDataDefaultTypeInternal {
  PROTOBUF_CONSTEXPR AtkDataDefaultTypeInternal() : _instance(::_pbi::ConstantInitialized{}) {}
  ~AtkDataDefaultTypeInternal() {}
  union {
    AtkData _instance;
  };
};
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 AtkDataDefaultTypeInternal _AtkData_default_instance_;
...
const ::uint32_t
    TableStruct_NetworkData_2eproto::offsets[] ABSL_ATTRIBUTE_SECTION_VARIABLE(
        ...
        ~0u,  // no _has_bits_
        PROTOBUF_FIELD_OFFSET(::NetworkData::AtkData, _internal_metadata_),
        ~0u,  // no _extensions_
        ~0u,  // no _oneof_case_
        ~0u,  // no _weak_field_map_
        ~0u,  // no _inlined_string_donated_
...
class AtkData::_Internal {
 public:
};

AtkData::AtkData(::google::protobuf::Arena* arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : ::google::protobuf::Message(arena, _class_data_.base()) {
#else   // PROTOBUF_CUSTOM_VTABLE
    : ::google::protobuf::Message(arena) {
#endif  // PROTOBUF_CUSTOM_VTABLE
  SharedCtor(arena);
  // @@protoc_insertion_point(arena_constructor:NetworkData.AtkData)
}
...
AtkData::AtkData(
  ...
  // @@protoc_insertion_point(copy_constructor:NetworkData.AtkData)
}
inline PROTOBUF_NDEBUG_INLINE AtkData::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena* arena)
...
AtkData::~AtkData() {
  // @@protoc_insertion_point(destructor:NetworkData.AtkData)
  SharedDtor(*this);
}
inline void AtkData::SharedDtor(MessageLite& self) {
...
inline void* AtkData::PlacementNew_(const void*, void* mem,
                                        ::google::protobuf::Arena* arena) {
  return ::new (mem) AtkData(arena);
}
constexpr auto AtkData::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(AtkData),
                                            alignof(AtkData));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull AtkData::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        &_AtkData_default_instance_._instance,
        &_table_.header,
        nullptr,  // OnDemandRegisterArenaDtor
        nullptr,  // IsInitialized
        &AtkData::MergeImpl,
        ::google::protobuf::Message::GetNewImpl<AtkData>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
        &AtkData::SharedDtor,
        ::google::protobuf::Message::GetClearImpl<AtkData>(), &AtkData::ByteSizeLong,
            &AtkData::_InternalSerialize,
#endif  // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(AtkData, _impl_._cached_size_),
        false,
    },
    &AtkData::kDescriptorMethods,
    &descriptor_table_NetworkData_2eproto,
    nullptr,  // tracker
};
const ::google::protobuf::internal::ClassData* AtkData::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(_class_data_.tc_table);
  return _class_data_.base();
}
...
PROTOBUF_NOINLINE void AtkData::Clear() {
// @@protoc_insertion_point(message_clear_start:NetworkData.AtkData)
  ::google::protobuf::internal::TSanWrite(&_impl_);
  ::uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
        ::uint8_t* AtkData::_InternalSerialize(
            const MessageLite& base, ::uint8_t* target,
            ::google::protobuf::io::EpsCopyOutputStream* stream) {
          const AtkData& this_ = static_cast<const AtkData&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
        ::uint8_t* AtkData::_InternalSerialize(
            ::uint8_t* target,
            ::google::protobuf::io::EpsCopyOutputStream* stream) const {
          const AtkData& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(serialize_to_array_start:NetworkData.AtkData)
          ::uint32_t cached_has_bits = 0;
          (void)cached_has_bits;
          ...
          // @@protoc_insertion_point(serialize_to_array_end:NetworkData.AtkData)
          return target;
        }

#if defined(PROTOBUF_CUSTOM_VTABLE)
        ::size_t AtkData::ByteSizeLong(const MessageLite& base) {
          const AtkData& this_ = static_cast<const AtkData&>(base);
#else   // PROTOBUF_CUSTOM_VTABLE
        ::size_t AtkData::ByteSizeLong() const {
          const AtkData& this_ = *this;
#endif  // PROTOBUF_CUSTOM_VTABLE
          // @@protoc_insertion_point(message_byte_size_start:NetworkData.AtkData)
          ::size_t total_size = 0;
...
void AtkData::MergeImpl(::google::protobuf::MessageLite& to_msg, const ::google::protobuf::MessageLite& from_msg) {
  auto* const _this = static_cast<AtkData*>(&to_msg);
  auto& from = static_cast<const AtkData&>(from_msg);
  // @@protoc_insertion_point(class_specific_merge_from_start:NetworkData.AtkData)
  ABSL_DCHECK_NE(&from, _this);
  ::uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
void AtkData::CopyFrom(const AtkData& from) {
// @@protoc_insertion_point(class_specific_copy_from_start:NetworkData.AtkData)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void AtkData::InternalSwap(AtkData* PROTOBUF_RESTRICT other) {
  using std::swap;
  auto* arena = GetArena();
...
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::_pbi::TcParseTable<2, 4, 1, 33, 2> RpcPacket::_table_ = {
  {
